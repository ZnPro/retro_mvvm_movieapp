...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder>{
    ...
    @NonNull
    @Override
    public MovieViewHolder onCreateViewHolder(@androidx.annotation.NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@androidx.annotation.NonNull MovieViewHolder holder, int position) {
